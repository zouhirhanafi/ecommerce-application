...
export const ProduitDeleteDialog = (props: IProduitDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommerceApp.ecommerceProduit.delete.question">
        <Translate contentKey="ecommerceApp.ecommerceProduit.delete.question" interpolate={{ id: produitEntity.id }}>
