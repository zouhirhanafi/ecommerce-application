...
export const CommandeDeleteDialog = (props: ICommandeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommerceApp.ecommerceCommande.delete.question">
        <Translate contentKey="ecommerceApp.ecommerceCommande.delete.question" interpolate={{ id: commandeEntity.id }}>
