...
export const ClientDeleteDialog = (props: IClientDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommerceApp.ecommerceClient.delete.question">
        <Translate contentKey="ecommerceApp.ecommerceClient.delete.question" interpolate={{ id: clientEntity.id }}>
