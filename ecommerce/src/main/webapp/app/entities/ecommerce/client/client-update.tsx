  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ecommerceApp.ecommerceClient.home.createOrEditLabel">
            <Translate contentKey="ecommerceApp.ecommerceClient.home.createOrEditLabel">Create or edit a Client</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : clientEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="telLabel" for="client-tel">
                  <Translate contentKey="ecommerceApp.ecommerceClient.tel">Tel</Translate>
                </Label>
                <AvField id="client-tel" type="text" name="tel" />
              </AvGroup>
              <AvGroup>
