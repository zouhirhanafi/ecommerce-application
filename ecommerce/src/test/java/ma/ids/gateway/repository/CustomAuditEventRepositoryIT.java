package ma.ids.gateway.repository;

import ma.ids.gateway.EcommerceApp;

import ma.ids.gateway.config.Constants;
import ma.ids.gateway.config.audit.AuditEventConverter;
import ma.ids.gateway.domain.PersistentAuditEvent;
...
import static ma.ids.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
