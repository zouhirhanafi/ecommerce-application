package ma.ids.gateway.web.rest;

import ma.ids.gateway.EcommerceApp;
import ma.ids.gateway.config.Constants;
import ma.ids.gateway.domain.User;
import ma.ids.gateway.repository.AuthorityRepository;
import ma.ids.gateway.repository.UserRepository;
import ma.ids.gateway.security.AuthoritiesConstants;
import ma.ids.gateway.service.UserService;
import ma.ids.gateway.service.dto.PasswordChangeDTO;
import ma.ids.gateway.service.dto.UserDTO;
import ma.ids.gateway.web.rest.vm.KeyAndPasswordVM;
import ma.ids.gateway.web.rest.vm.ManagedUserVM;
...
import static ma.ids.gateway.web.rest.AccountResourceIT.TEST_USER_LOGIN;
